            ...
            <div class='flex-auto sm:ml-5 justify-evenly'>
              ...
              <div class='flex pt-2  text-sm text-gray-400'>
                <div class='flex-1 inline-flex items-center'>
                  ...
                  {artists.length !== 0 ? (
                    <p class=''>Likes {artists.length} artists </p>
                  ) : null}
                </div>
                <div class='flex-1 inline-flex items-center'>
                  <svg
                  ...
                  {tracks.length !== 0 ? (
                    <p class=''>Likes {tracks.length} tracks </p>
                  ) : null}
                </div>
                <Link
                  to={`/profile/${user}`}
                  class='flex-no-shrink bg-green-600 hover:bg-green-500 p-1 ml-4  text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-green-100 hover:border-green-500 text-white rounded-full transition ease-in duration-300'
                >
                  View Profile
                </Link>
              </div>
