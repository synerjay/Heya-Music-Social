...
#     post = Post.objects.create(body=payload["body"], added_by=member, profile=profile)
...
#     Comment.objects.create(post=post, user=user, body=payload["body"], profile=profile)
